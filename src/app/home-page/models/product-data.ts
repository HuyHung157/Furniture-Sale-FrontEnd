...
export const PRODUCTS: Product[] = [
  {
    id: 1,
    name: 'Nexus S',
    src: '/assets/img/phones/nexus-s.0.jpg',
    price: 99.99,
  ...
  },
  {
    id: 2,
    name: 'Dell Venue',
    src: '/assets/img/phones/dell-venue.0.jpg',
    price: 109.99,
  ...
  },
  {
    id: 3,
    name: 'Droid 2',
    src: '/assets/img/phones/droid-2-global-by-motorola.0.jpg',
    price: 89.99,
    info: 'The Motorola Droid 2 is the fifth phone in Verizons Droid line. It runs the Android operating system by Google, and can run Flash Player 10.1. It comes with 8 GB of internal memory and is shipped with an additional 8 GB SDHC card, upgradable to 32 GB. It has a 3.7 in display and a 5-megapixel camera.'
  },
  {
    id: 4, name: 'Droid Pro',
    src: '/assets/img/phones/droid-pro-by-motorola.0.jpg',
    price: 129.99,
  ...
  {
    id: 5,
    name: 'Motorola Bravo', src: '/assets/img/phones/motorola-bravo-with-motoblur.0.jpg',
    price: 119.99,
  ...
  },
  {
    id: 6,
    name: 'Motorola Defy',
    src: '/assets/img/phones/motorola-defy-with-motoblur.0.jpg',
    price: 139.99,
